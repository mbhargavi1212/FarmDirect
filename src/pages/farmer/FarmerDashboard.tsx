    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200">
        <div>
          <div className="flex items-center gap-2">
            ...
            <Badge variant="success" size="sm">Verified Kisan</Badge>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          subtext="Ready for direct UPI / NEFT withdrawal"
          icon={CreditCard}
          accentColor="emerald"
        />
        <StatCard
          label="Active Harvest Lots"
          value={farmerProducts.length}
          subtext="Total available: 12,500 kg"
          icon={Package}
          accentColor="indigo"
        />
        <StatCard
          label="Pending Contract Orders"
          value={activeOrders.length}
          subtext="1 in transit, 1 completed"
          icon={ShoppingBag}
          accentColor="amber"
        />
        <StatCard
          label="Intermediary Fee Saved"
          value={formatCurrency(29600)}
          trend={{ value: '+28.4%', isPositive: true }}
          subtext="Bypassed APMC commission cut"
          icon={TrendingUp}
          accentColor="emerald"
        />
      </div>
          ...
          columns={[
            ...
            },
            {
              ...
              cell: (ord) => {
                ...
                return (
                  <Badge variant={isTransit ? 'info' : 'success'} size="sm">
